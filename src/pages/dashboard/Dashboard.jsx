...
import { Leaf, Moon, Target, Heart, BookOpen, Play } from "lucide-react";
    ...
    <AppLayout>
      <div className="w-full max-w-[1600px] mx-auto px-6">
        ...
        <section className="mb-10">
          ...
          <p className="text-slate-500 mt-3 text-base">Que bom te ver por aqui.</p>
          <p className="text-slate-500 text-base">Como você está se sentindo hoje?</p>
        </section>
            ...
            <div className="hidden lg:flex justify-center">
              <div className="relative">
                ...
                <div className="relative w-[420px] h-[420px] rounded-full overflow-hidden border-4 border-white shadow-2xl">
                  <img src={estampa} alt="estampa" className="w-full h-full object-cover" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-3xl font-semibold text-slate-800">Ações rápidas</h2>
        </div>

        <section className="grid grid-cols-2 lg:grid-cols-5 gap-6 mb-16">
          <Link to="/respirador">
            <Acao icon={<Leaf size={30} />} titulo="Respirar" subtitulo="Exercício rápido" cor="green" />
          </Link>
          <Link to="/dormir">
            <Acao icon={<Moon size={30} />} titulo="Dormir melhor" subtitulo="Sons e meditações" cor="violet" />
          </Link>
          <Link to="/focar">
            <Acao icon={<Target size={30} />} titulo="Focar" subtitulo="Concentre-se" cor="blue" />
          </Link>
          <Link to="/acalmar">
            <Acao icon={<Heart size={30} />} titulo="Me acalmar" subtitulo="Alivie a ansiedade" cor="pink" />
          </Link>
          <Link to="/diario">
            <Acao icon={<BookOpen size={30} />} titulo="Diário" subtitulo="Escreva o que sente" cor="orange" />
          </Link>
        </section>

        <div className="flex items-center justify-between mb-6">
          <h2 className="text-3xl font-semibold text-slate-800">Recomendado para você</h2>
        </div>

        <section className="grid lg:grid-cols-3 gap-7">
          <Recomendado titulo="Respiração para acalmar a mente" categoria="Exercício" tempo="5 min" fundo="from-[#DDF8EA] to-[#B8F0D1]" />
          <Recomendado titulo="Meditação para dormir melhor" categoria="Sono" tempo="8 min" fundo="from-[#5ED6A7] to-[#38B487]" />
          <Recomendado titulo="Como lidar com ansiedade escolar" categoria="Conteúdo" tempo="6 min" fundo="from-[#ECFFF5] to-[#D9F8E7]" />
        </section>
...
function Recomendado({ titulo, categoria, tempo, fundo }) {
  return (
    <div className="bg-white rounded-[30px] overflow-hidden border border-[#E8F3ED] hover:shadow-lg transition-all duration-300">
      ...
      <div className="p-6">
        <h3 className="text-2xl font-semibold leading-snug text-slate-800">{titulo}</h3>
