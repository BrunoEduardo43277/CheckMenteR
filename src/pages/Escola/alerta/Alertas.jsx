              ...
              {["Todos", "Alto", "Médio", "Baixo"].map((item) => (
                <button
                  ...
                  className={`px-5 py-3 rounded-2xl text-sm font-medium transition ${
                    filtro === item
                      ? "bg-[#27C4BD] text-white shadow-md"
...
function ResumoCard({ icon, titulo, valor, cor }) {
  const cores = {
    blue: "bg-[#E5F7EE] text-[#27C4BD]",
    red: "bg-red-50 text-red-500",
    orange: "bg-orange-50 text-orange-500",
    green: "bg-[#E5F7EE] text-[#38B487]",
  };
    ...
    <div className="rounded-[26px] border border-slate-100 bg-white p-6 shadow-sm hover:shadow-md transition">
      <div className="flex flex-col xl:flex-row xl:items-start xl:justify-between gap-6">
        <div className="flex gap-4">
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#27C4BD] to-[#38B487] text-white flex items-center justify-center font-semibold">
            {alerta.iniciais}
          </div>
      ...
      <div className="mt-6 grid lg:grid-cols-[1fr_auto] gap-5 items-center">
        <div className="bg-slate-50 rounded-2xl p-5">
          <div className="flex items-center gap-2 mb-2">
            <Brain size={18} className="text-[#27C4BD]" />
        ...
        <div className="flex flex-wrap gap-3">
          <button className="px-5 py-3 rounded-2xl bg-gradient-to-r from-[#27C4BD] to-[#38B487] text-white font-medium shadow-md flex items-center gap-2">
...
function BadgeNivel({ nivel }) {
  const estilos = {
    ...
    Baixo: "bg-[#E5F7EE] text-[#27C4BD] border-[#CBEFDD]",
  };
...
function BadgeStatus({ status }) {
  const estilos = {
    Resolvido: "bg-[#E5F7EE] text-[#38B487]",
